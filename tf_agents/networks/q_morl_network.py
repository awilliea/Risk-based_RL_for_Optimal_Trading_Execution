...
from tf_agents.networks import encoding_morl_network
...
class QNetwork(network.Network):
  ...
  def __init__(self,
    ...
    reward_size = input_tensor_spec[1].shape[0]

    encoder = encoding_morl_network.EncodingNetwork(
  ...
  def call(self, observation, step_type=None, network_state=(), training=False):
    ...
    """
    features, preference = observation
    #print("Eagerly:",tf.executing_eagerly(),"Training",training)
    state, network_state = self._encoder(
        features, preference=preference, step_type=step_type, network_state=network_state,
        training=training)
